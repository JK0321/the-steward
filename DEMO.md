# DEMO — run the Steward in 2 minutes

The fastest way to watch the Steward make a real call. Two ways: a **no-install browser preview**,
...
1. Open `the-steward-doc-to-md.html` in any browser.
2. Paste the test note below (or pick a sample chip) and hit **Route it →**.
3. You get the pile, the reasoning, and the `steward:` stamp — offline, nothing uploaded.
...
3. The Steward reads each file, moves it to the right pile, stamps *why*, and surfaces anything
