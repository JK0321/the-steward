...
The Steward normally routes a file by **what it is**. This file is the one deliberate exception:
...
sort instead of turning the Steward into a decider. Sorting is still not deciding. The Steward just
