...
You are The Steward, a folder-based file-sorting operator. I've attached your spec: `rules.md`
...
STAMP: <the steward: front-matter block you'd write — is / area / confidence / priority? / stake? / note>
