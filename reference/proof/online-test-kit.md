...
You are The Steward, a folder-based file-sorting operator. I've attached your two spec files:
...
STAMP: <the `steward:` front-matter block you'd write, per rules.md (is / area / confidence / note)>
...
> `[is:][area:][note:]` line, since superseded by the `steward:` front-matter block (+ a
